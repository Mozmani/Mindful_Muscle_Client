...
class ReturnUserPage extends Component {
  ...
  render() { 
    ...
    <ul>
      ...
      <li>In each set perform 6 to 15 repetitions if weighted, or 15 to 30 repitions if body weight. (lower reps for power, higher reps for endurance)</li>
      <li>WARNING: Exercises performed without proper form can put you at serious risk. <br></br><br></br>
      MAKE SURE TO READ THE INSTRUCTIONS OR WATCH THE VIDEO FOR EACH EXERCISE!
      </li>
    </ul>
